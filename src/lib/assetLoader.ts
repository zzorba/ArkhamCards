...
const ASSET_MODULES: { [key: string]: any } = {
  ...
  'taboos_zh-cn': require('../../assets/generated/taboos_zh_cn.txt'),
  'rules': require('../../assets/generated/rules.txt'),
  // Not present, use english
  'rules_cs': require('../../assets/generated/rules.txt'),
  ...
  // Not present, use english
  'rules_pt': require('../../assets/generated/rules.txt'),
  'rules_ru': require('../../assets/generated/rules_ru.txt'),
  // Not present, use english
  'rules_vi': require('../../assets/generated/rules.txt'),
