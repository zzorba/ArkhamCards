...
export type CreateCampaignOutputKeySpecifier = ('campaignId' | CreateCampaignOutputKeySpecifier)[];
...
export type UpdateHandleOutputKeySpecifier = ('success' | UpdateHandleOutputKeySpecifier)[];
