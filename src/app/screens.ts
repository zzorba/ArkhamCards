...
import ResolutionView from 'components/campaignguide/ResolutionView';
...
export function registerScreens(Provider: any, store: any) {
  ...
  Navigation.registerComponentWithRedux('Guide.Resolution', () => ResolutionView, Provider, store);
