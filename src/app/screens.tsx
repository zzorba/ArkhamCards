...
function getStandardComponent(componentName: string | number) {
  switch (componentName) {
    ...
    case 'Deck.Edit': return require('@components/deck/DeckEditView').default;
    ...
    case 'Guide.ChaosBag': return require('@components/campaignguide/GuideChaosBagView').default;
