  ...
  return (
    <ScrollView style={[space.paddingM, backgroundStyle]}>
      ...
      <View style={space.marginTopM}>
        <CardTextComponent onLinkPress={linkPressed}
          text={'<b>Translation:</b>\n• Spanish: [@TengounplanAH](https://twitter.com/TengounplanAH), Midraed and Alvaro\n• French: Alexandre Carpentier, Fabrice2, Aifé\n• German: Hauke, tjanu\n• Russian: Eugene Sarnetsky, Alexander “Sheff” Buryakov, [Artem “NL” Grechka](https://twitter.com/lnll), Max “Youbi” Zakharov, Vladimir “Sliptip” Litvaliev, Andrey “Dartemilion” Lubyanov, Mikhail “Necros47” Lisovsky, fnordmonkey\n• Korean: 엘케인(elkeinkrad), 푸른이(derornos)'} />
      </View>
      <View style={space.marginTopM}>
        <CardTextComponent onLinkPress={linkPressed}
