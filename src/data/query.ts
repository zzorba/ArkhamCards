...
export const STORY_CARDS_QUERY = `(((deck_limit >= 0) and (spoiler == true || (subtype_code != null && restrictions == null))) or code == "${RANDOM_BASIC_WEAKNESS}" or code == "${ACE_OF_RODS_CODE}")`;
