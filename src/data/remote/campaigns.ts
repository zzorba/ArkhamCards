...
import { FetchResult, MutationFunctionOptions, MutationUpdaterFn } from '@apollo/client';
...
const handleSetGuideInput: MutationUpdaterFn<AddGuideInputMutation> = (cache, { data }) => {
